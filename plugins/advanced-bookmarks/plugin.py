...
class AdvancedBookmarksPlugin(gedit.Plugin):
    ...
    def __init__(self):
        ...
        plugins_dir = "~/.gnome2/gedit/plugins" if not is_mate else "~/.config/pluma/plugins"
        conf_path = os.path.join(os.path.expanduser(plugins_dir), "advanced-bookmarks/plugin.conf")
